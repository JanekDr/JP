...
//pracownikow, opinie, trendy bedzie mozna modyfikowac poprzez podanie ID lub po wyswietleniu listy tych przypisow
    ...
    private EmployeesManager employeesManager = new EmployeesManager();
    private CommentManager commentManager = new CommentManager(employeesManager);
    ...
    public void displayMainMenu() throws IOException {
        ...
        int choice = getValidOptionInput(3);
    ...
    private void viewEmployees() throws IOException {
        List<Employee> employees = employeesManager.getEmployees();
        System.out.println("###############################");
    ...
    private void addComment() throws IOException {
        System.out.println("Podaj id pracowniku.");
        int employeeId = getValidIdInput();
    ...
    private String getValidOpinionType(){
        ...
        while(!valid){
            ...
            if(input.equals("pozytywna") || input.equals("negatywna"))valid=true;
        }
        return type;
    }
