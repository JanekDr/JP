...
public class AddProductToMealDialog extends JDialog {
    ...
    private void initUI(List<Product> availableProducts) {
        ...
        bottomPanel.add(new JLabel("Ilosc (mnoznik):"));
    ...
    private void onAdd() {
        ...
        if (selectedProducts.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Prosze wybrac przynajmniej jeden produkt.", "Brak Wyboru", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Prosze wprowadzic prawidlowa liczbe dodatnią jako mnoznik.", "Blad Wprowadzania", JOptionPane.ERROR_MESSAGE);
            return;
        }
